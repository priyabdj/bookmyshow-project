...
export const Payment = () => {
  ...
  const getMovies = () => {
    axios
      .get(`https://bookmyshow-clone-fw14.herokuapp.com/movies/${id}`)
      .then((res) => {
        setMovie(res.data);
      });
  };
  ...
  return (
    <div>
      {seats ? (
        <div className="ticketdiv">
          <div className="ticketpop">
            ...
            <div onClick={payit} className="kjvfsfln">
              Pay
            </div>
          </div>
        </div>
      ...
      <div className="Maindivpayment">
        <div className="firstdivpayment">
          ...
          <div>
            ...
            >
              <span>V</span>
              <span className="textv">
                <p>Unlock offers or Apply Promocodess</p>
              </span>
            </div>
            <div
              style={{
        ...
        <div className="seconddivpayment">
          <div className="oghyt">
            <p>ORDER SUMMARY</p>
            <p>
              {movie.title} ({movie.language}) ({movie.movieType})
              <h4>Tickets : {noseats}</h4>
            </p>
            <p>
              {movie.language}, {movie.screenType}
            </p>
          ...
          <div className="jiohvfd">
            ...
            <div className="uidsfiugf" onClick={bookmovie}>
              Pay amount
            </div>
          </div>
        </div>
      ...
      <div className="payfooter">
        ...
        <p>
          {" "}
          1.You can cancel the tickets 4 hour(s) before the show. Refunds will
