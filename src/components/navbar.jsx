...
//  import stream from "../components/images/stream.jpg";
 export const Navbar=()=>{
             ...
             <div className="city">
               <div className="cityinside">
                 ...
                 <div className="citiesdiv">
                   ...
                   <span onClick={()=>takecity("Delhi-NCR")} className="pointer"><img src="//in.bmscdn.com/m6/images/common-modules/regions/ncr.png" alt="Delhi-NCR" class="sc-bqjOQT aUKrX"/><p>Delhi-NCR</p></span>
